...
import { HeroVisual, DataFlowVisual } from "@/components/visuals";
        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          >
            ...
            <p className="mt-4 text-base sm:text-lg text-gray-400 max-w-xl mx-auto leading-relaxed">
              Cada solución se integra con las demás para crear una operación completa e inteligente.
            </p>
          ...
          >
            {[
              ...
              },
              {
                ...
                description: "Que funciona sola, sin intervención manual",
                color: "purple",
              },
            ].map((pillar, i) => {
              const colorMap = {
